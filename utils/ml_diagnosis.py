...
class MLDiagnosisModel:
    ...
    def load_model(self) -> bool:
        ...
        try:
            if (os.path.exists(f'{self.model_path}/vectorizer.pkl') and 
                os.path.exists(f'{self.model_path}/classifier.pkl') and 
                os.path.exists(f'{self.model_path}/label_encoder.pkl')):
